...
%Además, buscamos los polos y los ceros analíticamente con tf2zp:

[zeros, poles, gain] = tf2zp(b, a);

%Intentamos resuperar la función de transferencia con los polos y los
%ceros::
...
%En la circuenferencia no están los polos, pero sí los ceros, luego el
%sistema es estable.

%5.- RESPUESTA EN FRECUENCIA:

%Usamos la función que nos da H y lo pasamos a módulo y fase:
